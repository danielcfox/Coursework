...
def answer_one():
    ...
    return dc, cc, bc # Your Answer Here
...
def answer_two():
    ...
    node = max(dc.keys(), key=lambda x:dc[x])

    return node # Your Answer Here
...
def answer_three():
    ...
    node = max(cc.keys(), key=lambda x:cc[x])
...
def answer_four():
    ...
    node = max(bc.keys(), key=lambda x:bc[x])
...
def answer_six():
    ...
    return sorted(pr.keys(), key=lambda x:pr[x], reverse=True)[0:5] # Your Answer Here
...
def answer_eight():
    ...
    return sorted(hub.keys(), key=lambda x:hub[x], reverse=True)[0:5] # Your Answer Here
...
def answer_nine():
    ...
    return sorted(auth.keys(), key=lambda x:auth[x], reverse=True)[0:5] # Your Answer Here
